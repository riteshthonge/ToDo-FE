    ...
    <footer className='container-fluid footer-div d-flex flex-row flex-wrap justify-content-center' style={{backgroundColor:"#DCDCDC"}}>
        <section className='col-md-4 p-2'>
            ...
            <div className="conatiner m-0 p-0">
                <p className='hover m-0 p-0'>Copyright © 2025 by ToDo</p>
                <br />
                <p className='hover m-0 p-0'>ToDo,All rights reserved.</p>
            </div>
        </section>
        <section className='col-md-4 p-2'>
            <h6>Contact us</h6>
            <p className='hover m-0 p-0'>ToDo, Chatarapati complex, 2nd Floor, Barshi, Solapur 431411</p>
            <p className='hover m-0 p-0'>9834935898</p>
            <p className='hover m-0 p-0'>hello@P-ToDo.com</p>
        </section>
        <section className='col-md-4 p-2'>
        <h6>Account</h6>
